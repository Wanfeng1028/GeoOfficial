      ...
      items: [
        {
          ...
          description: '查询项目、理解数据。',
          enDescription: 'Query projects and understand data.',
          iconKey: 'assistant',
        },
        {
          label: 'AI',
          enLabel: 'AI',
          href: '/platform/ai',
          description: '专业 Agent 规划与执行工作。',
          enDescription: 'Plan and execute work with specialized agents.',
          iconKey: 'ai',
        },
        {
          label: '数据模型',
          enLabel: 'Data model',
          href: '/platform/data',
          description: '组织项目、数据和图层。',
          enDescription: 'Organize projects, data, and layers.',
          iconKey: 'dataModel',
        },
        {
          label: '项目上下文',
          ...
          description: '连接数据、地图、代码与工具。',
          enDescription: 'Connect data, maps, code, and tools.',
      ...
      items: [
        {
          ...
          description: '从问题定义到成果交付。',
          enDescription: 'End-to-end processes from question to delivery.',
          iconKey: 'workflows',
        },
        {
          label: '任务序列',
      ...
      items: [
        {
          ...
          description: '整理文献、日志与研究记录。',
          enDescription: 'Organize literature, logs, and research notes.',
        ...
        },
        {
          ...
          description: '生成地图、图表和报告。',
          enDescription: 'Generate maps, charts, metrics, and reports.',
          iconKey: 'reporting',
        },
      ],
    },
      ...
      items: [
        {
          ...
          enDescription: 'Get started, usage, and troubleshooting.',
          iconKey: 'help',
        },
        {
          label: '学习 GeoWork',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          enLabel: 'Developer Platform',
          href: '/platform/developers',
          description: '构建扩展和外部连接。',
          enDescription: 'Build extensions and external integrations.',
          iconKey: 'developerPlatform',
        },
      ],
    },
