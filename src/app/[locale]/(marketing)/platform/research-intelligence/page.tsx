...
const route = getRouteMeta('/platform/research-intelligence')!;
const pageData = getPlatformPage('research-intelligence')!;
...
export default function PlatformResearchIntelligencePage() {
